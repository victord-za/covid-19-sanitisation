...
const int solPulses = 3;                  // number of pulses in solenoid sequence
...
void solenoidpulse() {
    if (optval == 1){
      delay(waitTime);                  // keep solenoid off for specified amount of miliseconds allowing current client to walk to spray area
      digitalWrite(greenPin, LOW);      // turn off green light
      digitalWrite(redPin, HIGH);       // turn on red light
      for (int i = 1; i < solPulses; i++) {
        ...
        delay(waitTime);                     // keep solenoid off for specified amount of miliseconds
      }    
      digitalWrite(greenPin, HIGH);     // turn on green light
      digitalWrite(redPin, LOW);        // turn off red light
